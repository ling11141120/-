...
-- workflow_name    : tbl_dws_flow_element_exposure_ed
-- workflow_version : 3
-- create_user      : yanxh
-- task_name        : dws_flow_element_exposure_ed
-- task_version     : 3
-- update_time      : 2024-10-23 17:35:43
-- sql_path         : \starrocks\tbl_dws_flow_element_exposure_ed\dws_flow_element_exposure_ed
----------------------------------------------------------------
-- 前置SQL语句
delete from  dws.dws_flow_element_exposure_ed where dt>='${bf_3_dt}';

-- SQL语句
insert into   dws.dws_flow_element_exposure_ed
  ...
  a.page_name,a.page_id,a.element_name,a.element_id,a.send_id,a.payment_method,
  type as tps, activity_id,parent_group_id,group_id,
 count(1) as cnt,now() as etl_tm
 from dwd.dwd_sensors_production_element_expose_view a
 left join
