...
-- workflow_version : 13
-- create_user      : linq
-- task_name        : dws_video_user_watch_series_td_5_9
-- task_version     : 7
-- update_time      : 2025-06-09 18:39:54
-- sql_path         : \starrocks\tbl_dws_video_user_watch_a\dws_video_user_watch_series_td_5_9
----------------------------------------------------------------
-- SQL语句
...
-- workflow_version : 13
-- create_user      : linq
-- task_name        : dws_video_user_watch_series_td_a_0_4
-- task_version     : 8
-- update_time      : 2025-06-09 18:39:54
-- sql_path         : \starrocks\tbl_dws_video_user_watch_a\dws_video_user_watch_series_td_a_0_4
----------------------------------------------------------------
-- SQL语句
insert into dws.dws_video_user_watch_series_td_a
select t1.dt,t1.product_id,t1.user_id,fst_watch_tm,lst_watch_tm,t1.watch_series_td,t1.watch_tv_td,t1.watch_days_td,
