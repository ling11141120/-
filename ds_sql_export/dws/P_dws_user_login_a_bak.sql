...
-- workflow_name    : tbl_dws_user_login_a_bak
-- workflow_version : 3
-- create_user      : chenmo
-- task_name        : tbl_dws_user_login_a
-- task_version     : 3
-- update_time      : 2025-03-14 11:01:11
-- sql_path         : \starrocks\tbl_dws_user_login_a_bak\tbl_dws_user_login_a
----------------------------------------------------------------
-- SQL语句
insert into dws.dws_user_login_a_bak
    ...
    select   dt,
       ...
       login_times
       from
dws.dws_user_login_a_bak where dt='${bf_2_dt}'
...
(
   ...
   group by 1,2
    ...
    select
          ...
          max(case when  rank_desc=1 then createtime end ) as last_login_time,
          max(case when  rank_desc=1 then createtime end) as new_login_time,
          max(case when  rank_asc=1 then ip end) as first_login_ip,
          max(case when  rank_desc=1 then ip end) as last_login_ip,
...
-- task_version     : 3
-- update_time      : 2025-03-14 11:01:11
-- sql_path         : \starrocks\tbl_dws_user_login_a_bak\tbl_dws_user_login_a_3322
----------------------------------------------------------------
-- SQL语句
insert into dws.dws_user_login_a_bak
       select    '${bf_1_dt}' as dt,
...
-- task_version     : 3
-- update_time      : 2025-03-14 11:01:11
-- sql_path         : \starrocks\tbl_dws_user_login_a_bak\tbl_dws_user_login_a_3366
----------------------------------------------------------------
-- SQL语句
insert into dws.dws_user_login_a_bak
       select    '${bf_1_dt}' as dt,
...
-- task_version     : 3
-- update_time      : 2025-03-14 11:01:11
-- sql_path         : \starrocks\tbl_dws_user_login_a_bak\tbl_dws_user_login_a_3388
----------------------------------------------------------------
-- SQL语句
insert into dws.dws_user_login_a_bak
