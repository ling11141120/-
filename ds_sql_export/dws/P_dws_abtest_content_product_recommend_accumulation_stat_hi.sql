...
-- workflow_name    : tbl_dws_abtest_content_product_recommend_accumulation_stat_hi
-- workflow_version : 15
-- create_user      : xixg
-- task_name        : dws_abtest_content_product_recommend_accumulation_stat_hi
-- task_version     : 15
-- update_time      : 2025-05-24 11:01:34
-- sql_path         : \starrocks\tbl_dws_abtest_content_product_recommend_accumulation_stat_hi\dws_abtest_content_product_recommend_accumulation_stat_hi
----------------------------------------------------------------
-- SQL语句
-- 内容推荐---阅读业务  可累加指标小时统计
INSERT INTO dws.dws_abtest_content_product_recommend_accumulation_stat_hi
-- 阅读业务   总阅读章节数
...
INNER JOIN (
 ...
 AND  reco_acti_user.product_id = chapter.product_id
LEFT JOIN (
            SELECT
                project_id,
                exp_id,
