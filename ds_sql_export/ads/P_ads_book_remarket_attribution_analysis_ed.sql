...
-- workflow_version : 95
-- create_user      : xixg
-- task_name        : ads_book_remarket_attribution_analysis_ed
-- task_version     : 1
-- update_time      : 2025-05-15 15:41:33
-- sql_path         : \starrocks\sch_ads_optimize\ads_book_remarket_attribution_analysis_ed
----------------------------------------------------------------
-- SQL语句
delete from ads.ads_book_remarket_attribution_analysis_ed where  dt>='${bf_1_dt}';

-- SQL语句
insert into ads.ads_book_remarket_attribution_analysis_ed
with cte_charge as (
...
-- task_name        : ads_book_remarket_attribution_analysis_ed
-- task_version     : 11
-- update_time      : 2024-11-06 14:28:30
-- sql_path         : \starrocks\tbl_ads_book_remarket_attribution_analysis_ed\ads_book_remarket_attribution_analysis_ed
----------------------------------------------------------------
-- SQL语句
delete from ads.ads_book_remarket_attribution_analysis_ed where  dt>='${bf_1_dt}';
