...
-- workflow_version : 71
-- create_user      : yanxh
-- task_name        : ads_srsv_bi_ad_optimizer_priority_v1
-- task_version     : 27
-- update_time      : 2025-01-03 17:03:32
-- sql_path         : \starrocks\tbl_ads_srsv_bi_ad_optimizer_target_data_v1\ads_srsv_bi_ad_optimizer_priority_v1
----------------------------------------------------------------
-- 前置SQL语句
delete  from  ads.ads_srsv_bi_ad_optimizer_priority_v1 where  dt>='${bf_9_dt}'   and dt<='${dt}';

-- SQL语句
-- 已完成代码
    -- 时区处理后，hn的收入和充值人数,优化师
insert into  ads.ads_srsv_bi_ad_optimizer_priority_v1
