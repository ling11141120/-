...
-- workflow_name    : tbl_ads_bi_book_coin_consume_stat
-- workflow_version : 11
-- create_user      : zhengtt
-- task_name        : ads_bi_book_coin_consume_stat
-- task_version     : 11
-- update_time      : 2025-09-09 15:57:23
-- sql_path         : \starrocks\tbl_ads_bi_book_coin_consume_stat\ads_bi_book_coin_consume_stat
----------------------------------------------------------------
-- 前置SQL语句
delete from ads.ads_bi_book_coin_consume_stat where dt = '${bf_1_dt}';
...
select
    ...
    now() as etl_time
from
    (   select  a.dt,a.book_id,a.site_id,a.user_id,b.book_nature,b.book_name,b.build_time,a.mt,a.corever,
    CASE
    ...
    from
    (   select  a.book_id,a.book_code,b.copy_book_id,a.languageid
    from dim.dim_shuangwen_book_read_consume_info a
