...
,amt_2 as (select amt.dt
          ...
          select '${bf_1_dt}' as dt, product_id, mt, corever, ads_nmae, ad_show_type, 'test_20250725_2' as position_id, tps, ad_amt, ad_request_cnt, matched_request_cnt, impression_cnt, click_cnt, now() as etl_tm from amt_1
union all select '${bf_1_dt}' as dt, product_id, mt, corever, ads_nmae, ad_show_type, 'test_20250725_2' as position_id, tps, ad_amt, ad_request_cnt, matched_request_cnt, impression_cnt, click_cnt, now() as etl_tm from amt_2
;