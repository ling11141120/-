...
-- workflow_name    : tbl_dwm_ab_exp_recharge_data_di_copy_20250507111402759
-- workflow_version : 7
-- create_user      : hufengju
-- task_name        : dwm_ab_exp_recharge_data_di_temp
-- task_version     : 7
-- update_time      : 2025-05-07 16:06:28
-- sql_path         : \starrocks\tbl_dwm_ab_exp_recharge_data_di_copy_20250507111402759\dwm_ab_exp_recharge_data_di_temp
----------------------------------------------------------------
-- SQL语句
insert into dwm.`dwm_ab_exp_recharge_data_di_temp`
with
-- 充值数据与消费数据
t123 as(
	select t1.*
