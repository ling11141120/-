...
-- workflow_name    : tbl_dwm_consume_user_consume_w5_p_di
-- workflow_version : 3
-- create_user      : xixg
-- task_name        : dwm_consume_user_consume_w5_p_di
-- task_version     : 3
-- update_time      : 2024-10-16 15:39:01
-- sql_path         : \starrocks\tbl_dwm_consume_user_consume_w5_p_di\dwm_consume_user_consume_w5_p_di
----------------------------------------------------------------
-- SQL语句
delete from dwm.dwm_consume_user_consume_w5_p_di  where dt='${bf_1_dt}';

-- SQL语句
insert into dwm.dwm_consume_user_consume_w5_p_di
...
with t1 as (
    ...
    from dwd.dwd_consume_user_consume_explode where dt>='${bf_2_dt}' and (types in(1,2,3) or (types=4 and isFirst=1)) and date(hours_add(createtime,-13)) = '${bf_1_dt}'
...
select t1.dt,md5(concat_ws('_',t1.dt, t1.product_id,t1.user_id,t1.types,t1.pay_type,t1.site_id,t1.book_id,t1.chapter_ids,t1.Chapter_id)) as md5_key,
       ...
       acc.Create_Time as reg_date,datediff(t1.dt,acc.Create_Time) as reg_days,acc.reg_country as reg_country,acc.appver,acc.sex,other.is_negative_user,other.ads_type,other.ads_quality,acc.app_id as app_id,
