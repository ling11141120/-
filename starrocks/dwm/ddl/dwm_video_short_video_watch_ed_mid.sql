CREATE TABLE `dwm_video_short_video_watch_ed_mid` (
...
PRIMARY KEY(`dt`, `product_id`, `series_id`, `epis_num`)
COMMENT "海外短剧剧集观看中间表"
...
DISTRIBUTED BY HASH(`dt`, `product_id`, `series_id`, `epis_num`) BUCKETS 1 
PROPERTIES (
"replication_num" = "2",
