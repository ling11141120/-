CREATE TABLE `dwd_consume_user_consume_explode` (
  ...
  `amount` decimal(20, 6) NULL COMMENT "消费数额",
  `consume_cnt` decimal(20, 6) NULL COMMENT "消费次数",
...
DUPLICATE KEY(`dt`, `product_id`, `auto_id`, `types`)
COMMENT "消耗域用户消费事实表(炸开)"
