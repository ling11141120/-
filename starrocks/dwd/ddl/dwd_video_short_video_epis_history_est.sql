CREATE TABLE `dwd_video_short_video_epis_history_est` (
  ...
  `epis_num` int(11) NULL COMMENT "集数",
  `region_id` smallint(6) NULL COMMENT "归属区域 id，1：香港，2：北美；",
  `watch_over` tinyint(4) NULL COMMENT "是否观看完成",
