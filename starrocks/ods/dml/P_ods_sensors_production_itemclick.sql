...
-- workflow_name    : sensors_test_zhugl_copy_itemclick
-- workflow_version : 13
-- create_user      : zhugl
-- task_name        : tbl_ods_sensors_itemclick
-- task_version     : 11
-- update_time      : 2024-01-03 10:28:22
-- sql_path         : \starrocks\sensors_test_zhugl_copy_itemclick\tbl_ods_sensors_itemclick
----------------------------------------------------------------
-- SQL语句
insert into ods_log.ods_sensors_production_itemclick
select
...
from ods_log.ods_sensors_production_itemclick_hive where dt ='${bf_1_dt}';
