----------------------------------------------------------------
-- 目标表： ods.ods_tidb_sharpengine_ads_global_fbadagegenderdailyinsight
-- 来源实例： new_tidb_source
-- 来源表： sharpengine_ads_global.FbAdAgeGenderDailyInsight
-- 来源负责：
-- 采集工具： SeaTunnel
-- 开发人： xjc
-- 开发日期： 2025-12-22
...
drop table if exists ods.ods_tidb_sharpengine_ads_global_fbadagegenderdailyinsight;
create table ods.ods_tidb_sharpengine_ads_global_fbadagegenderdailyinsight (
    ...
    ,age                    varchar(384)     not null                     comment "年龄"
    ,gender                 varchar(384)     not null                     comment "性别"
    ...
    ,installs               int              not null                     comment "安装数"
    ,clicks                 int              not null                     comment "点击数"
    ,impressions            int              not null                     comment "展示数"
    ...
    ,apppurchase            int                                           comment "应用内付费次数"
...
primary key(dt,id)
comment "年龄性别维度消耗表 author:(742337)"
