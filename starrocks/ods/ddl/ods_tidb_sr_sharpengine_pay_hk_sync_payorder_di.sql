----------------------------------------------------------------
-- 目标表： ods.ods_tidb_sr_sharpengine_pay_hk_sync_payorder_di
-- 来源实例： old_tidb_source
-- 来源表： sharpengine_pay_hk_sync.PayOrder
-- 来源负责：
-- 采集工具： SeaTunnel
-- 开发人： qhr
-- 创建日期： 2026-01-07
...
drop table if exists ods.ods_tidb_sr_sharpengine_pay_hk_sync_payorder_di;
create table ods.ods_tidb_sr_sharpengine_pay_hk_sync_payorder_di (
    ...
    ,HasNotifyTimes     int                       comment ""
    ,PayConfigId        int                       comment ""
    ,Core               int                       comment ""
    ,BaseAmount         int                       comment "统计收入金额字段"
    ,UniqueGuid         string                    comment ""
    ,TestFlag           int                       comment "测试标记1为测试"
    ,CooExtStatus       int                       comment ""
    ,CooExtInfo         varchar(1048576)          comment ""
    ,BillInfo           varchar(1048576)          comment ""
    ,RowUpdateTimestamp datetime                  comment ""
    ,SubPayType         string                    comment "子渠道类型"
    ,AutoRenewTimes     int                       comment "续订次数"
    ,SubscribeStatus    int                       comment ""
    ,AppVer             string                    comment ""
