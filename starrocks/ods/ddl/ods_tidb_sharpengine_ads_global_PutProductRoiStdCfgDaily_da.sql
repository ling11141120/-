CREATE TABLE `ods_tidb_sharpengine_ads_global_PutProductRoiStdCfgDaily_da` (
  ...
  `BookChannel` int(11) NULL DEFAULT "-1" COMMENT "书籍类型",
...
PRIMARY KEY(`Id`)
COMMENT "阅读-投放语言ROI标准配置 author:(742337)"
