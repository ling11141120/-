----------------------------------------------------------------
-- 程序功能： AB实验核心指标流表（新增首页热剧榜消费效率指标）
-- 程序名： P_ads_ab_exp_core_index_stream
-- 目标表： ads.ads_ab_exp_core_index_stream
-- 负责人： qhr
-- 开发日期： 2026-03-09
-- 修改记录： 2026-05-26 新增 unlockCvr/viewCvr/unlockedEpisodesPerExposedUser/viewEpisodesPerExposedUser
----------------------------------------------------------------
...
select a.exp_id
    ...
    + ((l30_signin_recharge_amount + l30_svip_recharge_amount) / c.l30_exposure_uv) * 0.36
        ...
        , round(b.clc_cnt / b.exp_cnt, 6)                                                                    as ctr                             -- CTR（点击ctr：点击pv/曝光pv）
