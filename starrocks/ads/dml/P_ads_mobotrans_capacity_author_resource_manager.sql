        ...
        select site_id
          ...
          from (
                  select site_id
                        ...
                        ,count(distinct if(font_length_curmonth is not null
                                           and font_length_curmonth != 0, author_id, null))                           as active_num_curmonth
                        ,sum(if(font_length_curmonth is not null, font_length_curmonth, 0))                           as font_length_curmonth
                        ,sum(if(font_length_curmonth is not null
                                 and font_length_curmonth != 0 and AuthorId is not null, font_length_curmonth, 0))    as font_length_tar_curmonth
                        ,sum(if(font_length_curmonth is not null
                                 and font_length_curmonth != 0 and AuthorId is null, font_length_curmonth, 0))        as font_length_par_curmonth
                        ,count(distinct if(avg_score is not null
                                            and avg_score >= 3.4, author_id, null))                                   as score_a_num
                        ,count(distinct if(avg_score is not null
                                            and avg_score >= 3 and avg_score < 3.4, author_id, null))                 as score_b_num
                        ,count(distinct if(avg_score is not null
                                            and avg_score < 3, author_id, null))                                      as score_c_num
                    from ca
