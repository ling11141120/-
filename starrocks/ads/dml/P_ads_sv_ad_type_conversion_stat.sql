----------------------------------------------------------------
-- 程序功能： 海剧-广告触达到播放转化报表-分广告类型转化统计
-- 程序名： P_ads_sv_ad_type_conversion_stat
-- 目标表： ads.ads_sv_ad_type_conversion_stat
-- 负责人： xjc
-- 开发日期：2026-01-05
-- 版本号： v0.0.1
----------------------------------------------------------------

insert into ads.ads_sv_ad_type_conversion_stat
with adrequest as (
    select dt
          ,ad_show_type
          ,ad_show_type_name
...
select a1.dt                            as dt                       -- 日期
      ...
      ,a1.ad_show_type_name             as ad_show_type_name        -- 广告类型名称
      ...
      ,sum(a4.total_show_duration)      as total_show_duration      -- 总展示时长
