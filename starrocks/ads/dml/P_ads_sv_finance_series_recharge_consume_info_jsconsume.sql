...
-- workflow_name    : ads_sv_finance_series_recharge_consume_info_jsconsume
-- workflow_version : 14
-- create_user      : chenmo
-- task_name        : ads_sv_finance_series_recharge_consume_info_jsconsume
-- task_version     : 10
-- update_time      : 2025-03-29 20:32:16
-- sql_path         : \starrocks\ads_sv_finance_series_recharge_consume_info_jsconsume\ads_sv_finance_series_recharge_consume_info_jsconsume
----------------------------------------------------------------
-- SQL语句
insert into ads.ads_sv_finance_series_recharge_consume_info_jsconsume
select
    dt,
    one_id,
    product_id,
...
-- task_version     : 12
-- update_time      : 2025-03-29 20:32:16
-- sql_path         : \starrocks\ads_sv_finance_series_recharge_consume_info_jsconsume\records_to_delete
----------------------------------------------------------------
-- SQL语句
with records_to_delete as (
    ...
    join (
        ...
        from ads.ads_sv_finance_series_recharge_consume_info_jsconsume
        where amount_sum < 0
    ) b on b.rn = 1 and a.product_id = b.product_id and a.user_id = b.user_id and a.one_id >= b.one_id
)
delete from ads.ads_sv_finance_series_recharge_consume_info_jsconsume
...
----------------------------------------------------------------
-- project_name     : starrocks
-- workflow_name    : ads_sv_finance_series_recharge_consume_info_month
-- workflow_version : 12
-- create_user      : chenmo
-- task_name        : ads_sv_finance_series_recharge_consume_info_jsconsume
-- task_version     : 11
-- update_time      : 2026-01-07 15:59:49
-- sql_path         : \starrocks\ads_sv_finance_series_recharge_consume_info_month\ads_sv_finance_series_recharge_consume_info_jsconsume
----------------------------------------------------------------
-- SQL语句
-- 每日执行
insert into ads.ads_sv_finance_series_recharge_consume_info_jsconsume
...
-- task_version     : 11
-- update_time      : 2026-01-07 15:59:49
-- sql_path         : \starrocks\ads_sv_finance_series_recharge_consume_info_month\records_to_delete
----------------------------------------------------------------
-- SQL语句
with records_to_delete as (
    select
...
-- workflow_version : 36
-- create_user      : chenmo
-- task_name        : 海剧循环删除逻辑初次导入
-- task_version     : 1
-- update_time      : 2026-01-29 18:30:44
-- sql_path         : \starrocks\审计测试-总\海剧循环删除逻辑初次导入
----------------------------------------------------------------
-- SQL语句
...
-- sql_path         : \starrocks\审计测试-总_改\海剧循环删除逻辑初次导入
----------------------------------------------------------------
-- SQL语句
insert overwrite ads.ads_sv_finance_series_recharge_consume_info_jsconsume
select
...
-- task_name        : 海剧循环删除逻辑初次导入
-- task_version     : 4
-- update_time      : 2026-05-07 18:08:40
-- sql_path         : \starrocks\审计测试-总_改_补数\海剧循环删除逻辑初次导入
----------------------------------------------------------------
-- SQL语句
insert overwrite ads.ads_sv_finance_series_recharge_consume_info_jsconsume
select
