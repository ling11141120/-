...
-- workflow_name    : tbl_ads_series_attribution_match_rate_new
-- workflow_version : 11
-- create_user      : chenmo
-- task_name        : sr_ads_series_attribution_match_rate
-- task_version     : 9
-- update_time      : 2025-12-02 14:27:17
-- sql_path         : \starrocks\tbl_ads_series_attribution_match_rate_new\sr_ads_series_attribution_match_rate
----------------------------------------------------------------
-- 前置SQL语句
delete from ads.ads_series_attribution_match_rate_new where dt >= '${bf_3_dt}';
...
-- workflow_version : 11
-- create_user      : chenmo
-- task_name        : sv_ads_series_attribution_match_rate
-- task_version     : 8
-- update_time      : 2025-12-02 14:27:17
-- sql_path         : \starrocks\tbl_ads_series_attribution_match_rate_new\sv_ads_series_attribution_match_rate
----------------------------------------------------------------
-- 前置SQL语句
delete from ads.ads_series_attribution_match_rate_new where dt >= '${bf_3_dt}';
