----------------------------------------------------------------
-- 程序功能： AB实验核心指标表（新增首页热剧榜消费效率指标）
-- 程序名： P_ads_ab_exp_core_index
-- 目标表： ads.ads_ab_exp_core_index
-- 负责人： qhr
-- 开发日期： 2026-03-09
-- 修改记录： 2026-05-26 新增 unlockCvr/viewCvr/unlockedEpisodesPerExposedUser/viewEpisodesPerExposedUser 及分子分母
----------------------------------------------------------------
   ...
   , fuzha_data_tmp as (
    select a.exp_id                                                                                                            -- 实验ID
        ...
        , 4
         ...
         -- 新增：首页热剧榜消费效率指标
         , round(a.unlockNum / nullif(a.exposureNum, 0), 6)                                 as unlockCvr                       -- 解锁转化率
         , a.unlockNum                                                                      as unlockCvrFenzi                  -- 解锁转化率分子
         , a.exposureNum                                                                    as unlockCvrFenmu                  -- 解锁转化率分母
         , round(a.viewNum / nullif(a.exposureNum, 0), 6)                                   as viewCvr                         -- 观看转化率
         , a.viewNum                                                                        as viewCvrFenzi                    -- 观看转化率分子
         , a.exposureNum                                                                    as viewCvrFenmu                    -- 观看转化率分母
         , round(b.allUnlockEpisodeNum / nullif(a.exposureNum, 0), 6)                       as unlockedEpisodesPerExposedUser  -- 每曝光用户解锁集数
         , round(b.viewEpisodeNum / nullif(a.exposureNum, 0), 6)                            as viewEpisodesPerExposedUser      -- 每曝光用户观看集数
