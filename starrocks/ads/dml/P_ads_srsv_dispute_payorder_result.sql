...
select a1.id                                   as dt                                   -- id
      ,a1.product_type                         as product_type                         -- 三方产品类型，stripe，paypal
      ...
      ,a1.dispute_fee                          as dispute_fee                          -- stripe处理费(初始),预扣争议费用
...
select a1.id                             as dt                                   -- id
      ...
      ,a1.dispute_fee                    as dispute_fee                          -- stripe处理费(初始),预扣争议费用
      ,a1.final_amount                   as final_amount                         -- 损失金额
      ,a1.adjudication_amount            as final_balance_transactions_amount    -- 退款金额
      ,a1.final_dispute_fee              as final_dispute_fee                    -- 争议费用
      ,a1.balance_transactions_amount    as balance_transactions_amount          -- 争议金额
      ,a1.is_status_succeed              as is_status_succeed                    -- 是否胜诉，1是0否
      ,a1.final_status                   as final_status                         -- 最终状态
...
select a1.id                             as dt                                   -- id
      ...
      ,a1.dispute_fee                    as dispute_fee                          -- stripe处理费(初始),预扣争议费用
      ,a1.final_amount                   as final_amount                         -- 损失金额
      ,a1.dispute_judged_amount          as final_balance_transactions_amount    -- 退款金额
      ,a1.final_dispute_fee              as final_dispute_fee                    -- 争议费用
      ,a1.balance_transactions_amount    as balance_transactions_amount          -- 争议金额
      ,a1.is_status_succeed              as is_status_succeed                    -- 是否胜诉，1是0否
      ,a1.final_status                   as final_status                         -- 最终状态
...
select a1.id                             as dt                                   -- id
      ...
      ,a1.dispute_fee                    as dispute_fee                          -- stripe处理费(初始),预扣争议费用
      ,a1.final_amount                   as final_amount                         -- 损失金额
      ,a1.final_settle_amount            as final_balance_transactions_amount    -- 退款金额
      ,a1.final_dispute_fee              as final_dispute_fee                    -- 争议费用
      ,a1.balance_transactions_amount    as balance_transactions_amount          -- 争议金额
      ,a1.is_status_succeed              as is_status_succeed                    -- 是否胜诉，1是0否
      ,a1.final_status                   as final_status                         -- 最终状态
