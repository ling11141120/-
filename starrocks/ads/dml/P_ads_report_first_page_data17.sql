...
-- workflow_version : 21
-- create_user      : xixg
-- task_name        : ads_report_first_page_data17
-- task_version     : 1
-- update_time      : 2025-06-24 18:00:04
-- sql_path         : \starrocks\sch_ads_report_first_page\ads_report_first_page_data17
----------------------------------------------------------------
-- 前置SQL语句
truncate table ads.ads_report_first_page_data17;

-- SQL语句
INSERT INTO ads.ads_report_first_page_data17
...
from
    (
        ...
        where  dt>=date_sub(curdate(),interval 30 day)  and self_type = 2
          and  1 =1
        GROUP BY 1
