...
-- sql_path         : \starrocks\审计测试-总\SDK充值汇总
----------------------------------------------------------------
-- 前置SQL语句
delete from ads.ads_srsv_sdk_recharge_summary where dt >= date_format(date_sub('${dt}', interval 1 month), '%Y-%m-01');
...
-- sql_path         : \starrocks\审计测试-总_改\SDK充值汇总
----------------------------------------------------------------
-- 前置SQL语句
delete from ads.ads_srsv_sdk_recharge_summary where dt >= '$[add_months(yyyy-MM, -1)]-01';
