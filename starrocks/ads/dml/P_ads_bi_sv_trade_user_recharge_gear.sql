...
-- workflow_name    : tbl_ads_bi_sv_trade_user_recharge_gear
-- workflow_version : 12
-- create_user      : linq
-- task_name        : ads_bi_sv_trade_user_recharge_gear
-- task_version     : 12
-- update_time      : 2025-02-13 16:26:52
-- sql_path         : \starrocks\tbl_ads_bi_sv_trade_user_recharge_gear\ads_bi_sv_trade_user_recharge_gear
----------------------------------------------------------------
-- 前置SQL语句
...
payorder as (
 select a.dt,a.product_id,a.user_id,b.current_language2 as reg_language,b.source_chl AS source_chl,b.reg_country AS reg_country,ifnull(d.level,2) as country_level,
...
select
    a.dt,
    b.period_type,
    a.product_id,a.user_id,a.reg_language,a.source_chl,a.reg_country,a.country_level,a.mt,a.corever,
    b.user_type,
