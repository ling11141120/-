...
select a.dt
  ...
  from (select dt
          ...
          from (select b.order_id
                  ...
                  from(select dt
                             ,UserId               as user_id
                             ,OrderSerialId        as order_id
                             ,Amount/100           as amount
                             ,BaseAmount/100       as base_amount
                             ,RateAmount/100       as rate_amount
                             ,OrderCreateTime      as create_time
                             ,dc                   as dc_code
                             ,DcAccount            as dc_account
                             ,OsType               as mt
                             ,core
                             ,PaySource            as book_id
                             ,AccountCreateTime    as user_install_time
        ...
        select dt
              ...
              ,1          as user_type
              ,inst_id    as dc_code
              ,dc_acct    as dc_account
              ,core
              ,mt
              ,dev_unt    as new_user_count
              ,0          as pay_user_count
