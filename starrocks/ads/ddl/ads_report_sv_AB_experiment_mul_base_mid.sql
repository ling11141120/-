CREATE TABLE `ads_report_sv_AB_experiment_mul_base_mid` (
...
PRIMARY KEY(`dt`, `source_types`, `push_type`, `is_toufang`, `product_id`, `lang_id`, `user_id`, `series_id`)
COMMENT "海剧算法ab实验曝光基础中间表"
