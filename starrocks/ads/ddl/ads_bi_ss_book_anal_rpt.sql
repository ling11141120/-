...
CREATE TABLE ads.ads_bi_ss_book_anal_rpt (
    ...
    ,book_cmp_stat     VARCHAR(20)            COMMENT '书籍完本状态'
    ,mat_is_cmp        VARCHAR(20)            COMMENT '物料是否齐全'
    ...
    ,trl_cost          DECIMAL(10,4)          COMMENT '翻译成本'
    ,sign_ctr_cost     DECIMAL(10,4)          COMMENT '签约成本'
    ,ad_cost           DECIMAL(10,4)          COMMENT '广告成本'
    ,amt_mon           DECIMAL(10,4)          COMMENT '本月收入'
    ,amt_30d           DECIMAL(10,4)          COMMENT '近30天收入'
    ,amt_7d            DECIMAL(10,4)          COMMENT '近7天收入'
    ,d_rev             DECIMAL(10,4)          COMMENT '当日收入'
)
PRIMARY KEY (dt, product_id, book_id)
COMMENT 'bi-短篇书籍项目收益明细报表'
