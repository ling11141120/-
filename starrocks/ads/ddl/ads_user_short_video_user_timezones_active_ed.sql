CREATE TABLE `ads_user_short_video_user_timezones_active_ed` (
  `dt` date NOT NULL COMMENT "日期（用户当地时区）",
  ...
  `popularize_series_code` varchar(100) NULL COMMENT "推广剧编号",
