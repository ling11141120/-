...
(
    ...
    primary key(dt, hour_time, core, acquisition_source_cd, language_code, series_id)
comment "北斗短剧-播放量趋势表(小时粒度)"
partition by date_trunc("day", dt)
distributed by hash(dt, core, acquisition_source_cd, language_code, series_id) buckets 3
properties (
    "replication_num" = "3",
