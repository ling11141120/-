CREATE TABLE `ads_wide_user_info_ed` (
  `dt` date NOT NULL COMMENT "业务数据事件时间",
  ...
  `reg_time` datetime NULL COMMENT "注册时时间",
  `reg_country` varchar(255) NULL COMMENT "注册时国家",
  `country` varchar(255) NULL COMMENT "当前国家",
  `app_ver` varchar(255) NULL COMMENT "app版本号",
  `ver` varchar(255) NULL COMMENT "服务器版本号",
  `country_level` int(11) NULL COMMENT "国家等级（注册国家）",
  `consume_amt` decimal(18, 6) NULL COMMENT "消耗货币数",
  `consume_cnt` int(11) NULL COMMENT "消耗次数",
  `consume_book_cnt` bitmap NULL COMMENT "消耗书本数",
  `consume_chapter_cnt` bitmap NULL COMMENT "消耗章节数",
  `consume_money_amt` decimal(18, 6) NULL COMMENT "阅币消耗数",
  `consume_money_cnt` int(11) NULL COMMENT "阅币消耗次数",
  `consume_money_book_cnt` bitmap NULL COMMENT "阅币消耗书本数",
  `consume_money_chapter_cnt` bitmap NULL COMMENT "阅币消耗章节数",
  `consume_gift_amt` decimal(18, 6) NULL COMMENT "礼券消耗数",
  `consume_gift_cnt` int(11) NULL COMMENT "礼券消耗次数",
  `consume_gift_book_cnt` bitmap NULL COMMENT "礼券消耗书本数",
  `consume_gift_chapter_cnt` bitmap NULL COMMENT "礼券消耗章节数",
  `consume_award_amt` decimal(18, 6) NULL COMMENT "赠送币消耗数",
  `consume_award_cnt` int(11) NULL COMMENT "赠送币消耗次数",
  `consume_award_book_cnt` bitmap NULL COMMENT "赠送币消耗书本数",
  `consume_award_chapter_cnt` bitmap NULL COMMENT "赠送币消耗章节数",
  `consume_vip_amt` decimal(18, 6) NULL COMMENT "vip消耗数",
  `consume_vip_cnt` int(11) NULL COMMENT "vip消耗次数",
  `consume_vip_book_cnt` bitmap NULL COMMENT "vip消耗书本数",
  `consume_vip_chapter_cnt` bitmap NULL COMMENT "vip消耗章节数",
  `bat_ulk_cnt` int(11) NULL COMMENT "批量解锁次数",
  `fix_ulk_cnt` int(11) NULL COMMENT "一口价解锁次数",
  `sup_ulk_cnt` int(11) NULL COMMENT "超点解锁次数",
  `sup_ulk_amt` decimal(18, 6) NULL COMMENT "超点解锁货币数",
  `bat_ulk_money_amt` decimal(18, 6) NULL COMMENT "批量解锁阅币数",
  `consume_point_amt` int(11) NULL COMMENT "积分消耗数",
  `consume_point_cnt` int(11) NULL COMMENT "积分消耗次数",
  `login_time_cnt` int(11) NULL COMMENT "登录次数",
  `ordinary_recharge_amt` int(11) NULL COMMENT "普通充值金额",
  `ordinary_recharge_cnt` int(11) NULL COMMENT "普通充值次数",
  `vip_recharge_amt` int(11) NULL COMMENT "vip会员卡充值金额",
  `vip_recharge_cnt` int(11) NULL COMMENT "vip会员卡充值次数",
  `sub_recharge_amt` int(11) NULL COMMENT "订阅项充值金额",
  `sub_recharge_cnt` int(11) NULL COMMENT "订阅项充值次数",
  `read_times` int(11) NULL COMMENT "阅读时长",
  `read_book_cnt` bitmap NULL COMMENT "阅读书本数",
  `read_chapter_cnt` bitmap NULL COMMENT "阅读章节数",
  `read_cnt` int(11) NULL COMMENT "阅读次数",
  `get_money_amt` int(11) NULL COMMENT "获取阅币数",
  `get_gift_amt` int(11) NULL COMMENT "获取礼券数",
  `get_award_amt` int(11) NULL COMMENT "获取赠送币数",
  `get_point_amt` int(11) NULL COMMENT "获取积分数",
  `get_point_cnt` int(11) NULL COMMENT "获取积分次数",
  `produce_ads_amt` decimal(18, 6) NULL COMMENT "用户看广告产生收益预估金额",
  `produce_ads_cnt` int(11) NULL COMMENT "用户看广告产生收益次数",
  `bal_money_amt` int(11) NULL COMMENT "阅币余额",
  `bal_gift_amt` int(11) NULL COMMENT "礼券余额",
  `bal_point_amt` int(11) NULL COMMENT "积分余额",
...
COMMENT "用户维度，阅读-各业务域按天统计指标"
PARTITION BY RANGE(`dt`)
(PARTITION p20200601 VALUES [("2020-06-01"), ("2020-06-02")),
PARTITION p20200602 VALUES [("2020-06-02"), ("2020-06-03")),
PARTITION p20200603 VALUES [("2020-06-03"), ("2020-06-04")),
PARTITION p20200604 VALUES [("2020-06-04"), ("2020-06-05")),
PARTITION p20200605 VALUES [("2020-06-05"), ("2020-06-06")),
PARTITION p20200606 VALUES [("2020-06-06"), ("2020-06-07")),
PARTITION p20200607 VALUES [("2020-06-07"), ("2020-06-08")),
PARTITION p20200608 VALUES [("2020-06-08"), ("2020-06-09")),
PARTITION p20200609 VALUES [("2020-06-09"), ("2020-06-10")),
PARTITION p20200610 VALUES [("2020-06-10"), ("2020-06-11")),
PARTITION p20200611 VALUES [("2020-06-11"), ("2020-06-12")),
PARTITION p20200612 VALUES [("2020-06-12"), ("2020-06-13")),
PARTITION p20200613 VALUES [("2020-06-13"), ("2020-06-14")),
PARTITION p20200614 VALUES [("2020-06-14"), ("2020-06-15")),
PARTITION p20200615 VALUES [("2020-06-15"), ("2020-06-16")),
PARTITION p20200616 VALUES [("2020-06-16"), ("2020-06-17")),
PARTITION p20200617 VALUES [("2020-06-17"), ("2020-06-18")),
PARTITION p20200618 VALUES [("2020-06-18"), ("2020-06-19")),
PARTITION p20200619 VALUES [("2020-06-19"), ("2020-06-20")),
PARTITION p20200620 VALUES [("2020-06-20"), ("2020-06-21")),
PARTITION p20200621 VALUES [("2020-06-21"), ("2020-06-22")),
PARTITION p20200622 VALUES [("2020-06-22"), ("2020-06-23")),
PARTITION p20200623 VALUES [("2020-06-23"), ("2020-06-24")),
PARTITION p20200624 VALUES [("2020-06-24"), ("2020-06-25")),
PARTITION p20200625 VALUES [("2020-06-25"), ("2020-06-26")),
PARTITION p20200626 VALUES [("2020-06-26"), ("2020-06-27")),
PARTITION p20200627 VALUES [("2020-06-27"), ("2020-06-28")),
PARTITION p20200628 VALUES [("2020-06-28"), ("2020-06-29")),
PARTITION p20200629 VALUES [("2020-06-29"), ("2020-06-30")),
PARTITION p20200630 VALUES [("2020-06-30"), ("2020-07-01")),
...
PARTITION p20200704 VALUES [("2020-07-04"), ("2020-07-05")),
PARTITION p20200705 VALUES [("2020-07-05"), ("2020-07-06")),
PARTITION p20200706 VALUES [("2020-07-06"), ("2020-07-07")),
PARTITION p20200707 VALUES [("2020-07-07"), ("2020-07-08")),
PARTITION p20200708 VALUES [("2020-07-08"), ("2020-07-09")),
PARTITION p20200709 VALUES [("2020-07-09"), ("2020-07-10")),
PARTITION p20200710 VALUES [("2020-07-10"), ("2020-07-11")),
PARTITION p20200711 VALUES [("2020-07-11"), ("2020-07-12")),
PARTITION p20200712 VALUES [("2020-07-12"), ("2020-07-13")),
PARTITION p20200713 VALUES [("2020-07-13"), ("2020-07-14")),
PARTITION p20200714 VALUES [("2020-07-14"), ("2020-07-15")),
PARTITION p20200715 VALUES [("2020-07-15"), ("2020-07-16")),
PARTITION p20200716 VALUES [("2020-07-16"), ("2020-07-17")),
PARTITION p20200717 VALUES [("2020-07-17"), ("2020-07-18")),
PARTITION p20200718 VALUES [("2020-07-18"), ("2020-07-19")),
PARTITION p20200719 VALUES [("2020-07-19"), ("2020-07-20")),
PARTITION p20200720 VALUES [("2020-07-20"), ("2020-07-21")),
PARTITION p20200721 VALUES [("2020-07-21"), ("2020-07-22")),
PARTITION p20200722 VALUES [("2020-07-22"), ("2020-07-23")),
PARTITION p20200723 VALUES [("2020-07-23"), ("2020-07-24")),
PARTITION p20200724 VALUES [("2020-07-24"), ("2020-07-25")),
PARTITION p20200725 VALUES [("2020-07-25"), ("2020-07-26")),
PARTITION p20200726 VALUES [("2020-07-26"), ("2020-07-27")),
PARTITION p20200727 VALUES [("2020-07-27"), ("2020-07-28")),
PARTITION p20200728 VALUES [("2020-07-28"), ("2020-07-29")),
PARTITION p20200729 VALUES [("2020-07-29"), ("2020-07-30")),
PARTITION p20200730 VALUES [("2020-07-30"), ("2020-07-31")),
PARTITION p20200731 VALUES [("2020-07-31"), ("2020-08-01")),
PARTITION p20200801 VALUES [("2020-08-01"), ("2020-08-02")),
PARTITION p20200802 VALUES [("2020-08-02"), ("2020-08-03")),
PARTITION p20200803 VALUES [("2020-08-03"), ("2020-08-04")),
PARTITION p20200804 VALUES [("2020-08-04"), ("2020-08-05")),
PARTITION p20200805 VALUES [("2020-08-05"), ("2020-08-06")),
PARTITION p20200806 VALUES [("2020-08-06"), ("2020-08-07")),
PARTITION p20200807 VALUES [("2020-08-07"), ("2020-08-08")),
PARTITION p20200808 VALUES [("2020-08-08"), ("2020-08-09")),
...
PARTITION p20200813 VALUES [("2020-08-13"), ("2020-08-14")),
PARTITION p20200814 VALUES [("2020-08-14"), ("2020-08-15")),
PARTITION p20200815 VALUES [("2020-08-15"), ("2020-08-16")),
PARTITION p20200816 VALUES [("2020-08-16"), ("2020-08-17")),
PARTITION p20200817 VALUES [("2020-08-17"), ("2020-08-18")),
PARTITION p20200818 VALUES [("2020-08-18"), ("2020-08-19")),
PARTITION p20200819 VALUES [("2020-08-19"), ("2020-08-20")),
PARTITION p20200820 VALUES [("2020-08-20"), ("2020-08-21")),
PARTITION p20200821 VALUES [("2020-08-21"), ("2020-08-22")),
PARTITION p20200822 VALUES [("2020-08-22"), ("2020-08-23")),
PARTITION p20200823 VALUES [("2020-08-23"), ("2020-08-24")),
PARTITION p20200824 VALUES [("2020-08-24"), ("2020-08-25")),
PARTITION p20200825 VALUES [("2020-08-25"), ("2020-08-26")),
PARTITION p20200826 VALUES [("2020-08-26"), ("2020-08-27")),
PARTITION p20200827 VALUES [("2020-08-27"), ("2020-08-28")),
PARTITION p20200828 VALUES [("2020-08-28"), ("2020-08-29")),
PARTITION p20200829 VALUES [("2020-08-29"), ("2020-08-30")),
PARTITION p20200830 VALUES [("2020-08-30"), ("2020-08-31")),
PARTITION p20200831 VALUES [("2020-08-31"), ("2020-09-01")),
PARTITION p20200901 VALUES [("2020-09-01"), ("2020-09-02")),
PARTITION p20200902 VALUES [("2020-09-02"), ("2020-09-03")),
PARTITION p20200903 VALUES [("2020-09-03"), ("2020-09-04")),
PARTITION p20200904 VALUES [("2020-09-04"), ("2020-09-05")),
PARTITION p20200905 VALUES [("2020-09-05"), ("2020-09-06")),
PARTITION p20200906 VALUES [("2020-09-06"), ("2020-09-07")),
PARTITION p20200907 VALUES [("2020-09-07"), ("2020-09-08")),
PARTITION p20200908 VALUES [("2020-09-08"), ("2020-09-09")),
PARTITION p20200909 VALUES [("2020-09-09"), ("2020-09-10")),
PARTITION p20200910 VALUES [("2020-09-10"), ("2020-09-11")),
PARTITION p20200911 VALUES [("2020-09-11"), ("2020-09-12")),
PARTITION p20200912 VALUES [("2020-09-12"), ("2020-09-13")),
PARTITION p20200913 VALUES [("2020-09-13"), ("2020-09-14")),
PARTITION p20200914 VALUES [("2020-09-14"), ("2020-09-15")),
PARTITION p20200915 VALUES [("2020-09-15"), ("2020-09-16")),
PARTITION p20200916 VALUES [("2020-09-16"), ("2020-09-17")),
PARTITION p20200917 VALUES [("2020-09-17"), ("2020-09-18")),
PARTITION p20200918 VALUES [("2020-09-18"), ("2020-09-19")),
PARTITION p20200919 VALUES [("2020-09-19"), ("2020-09-20")),
PARTITION p20200920 VALUES [("2020-09-20"), ("2020-09-21")),
PARTITION p20200921 VALUES [("2020-09-21"), ("2020-09-22")),
PARTITION p20200922 VALUES [("2020-09-22"), ("2020-09-23")),
PARTITION p20200923 VALUES [("2020-09-23"), ("2020-09-24")),
PARTITION p20200924 VALUES [("2020-09-24"), ("2020-09-25")),
PARTITION p20200925 VALUES [("2020-09-25"), ("2020-09-26")),
PARTITION p20200926 VALUES [("2020-09-26"), ("2020-09-27")),
PARTITION p20200927 VALUES [("2020-09-27"), ("2020-09-28")),
PARTITION p20200928 VALUES [("2020-09-28"), ("2020-09-29")),
PARTITION p20200929 VALUES [("2020-09-29"), ("2020-09-30")),
PARTITION p20200930 VALUES [("2020-09-30"), ("2020-10-01")),
PARTITION p20201001 VALUES [("2020-10-01"), ("2020-10-02")),
PARTITION p20201002 VALUES [("2020-10-02"), ("2020-10-03")),
PARTITION p20201003 VALUES [("2020-10-03"), ("2020-10-04")),
PARTITION p20201004 VALUES [("2020-10-04"), ("2020-10-05")),
PARTITION p20201005 VALUES [("2020-10-05"), ("2020-10-06")),
PARTITION p20201006 VALUES [("2020-10-06"), ("2020-10-07")),
PARTITION p20201007 VALUES [("2020-10-07"), ("2020-10-08")),
PARTITION p20201008 VALUES [("2020-10-08"), ("2020-10-09")),
PARTITION p20201009 VALUES [("2020-10-09"), ("2020-10-10")),
...
PARTITION p20201013 VALUES [("2020-10-13"), ("2020-10-14")),
PARTITION p20201014 VALUES [("2020-10-14"), ("2020-10-15")),
PARTITION p20201015 VALUES [("2020-10-15"), ("2020-10-16")),
PARTITION p20201016 VALUES [("2020-10-16"), ("2020-10-17")),
PARTITION p20201017 VALUES [("2020-10-17"), ("2020-10-18")),
PARTITION p20201018 VALUES [("2020-10-18"), ("2020-10-19")),
PARTITION p20201019 VALUES [("2020-10-19"), ("2020-10-20")),
PARTITION p20201020 VALUES [("2020-10-20"), ("2020-10-21")),
...
PARTITION p20201025 VALUES [("2020-10-25"), ("2020-10-26")),
PARTITION p20201026 VALUES [("2020-10-26"), ("2020-10-27")),
PARTITION p20201027 VALUES [("2020-10-27"), ("2020-10-28")),
PARTITION p20201028 VALUES [("2020-10-28"), ("2020-10-29")),
PARTITION p20201029 VALUES [("2020-10-29"), ("2020-10-30")),
PARTITION p20201030 VALUES [("2020-10-30"), ("2020-10-31")),
PARTITION p20201031 VALUES [("2020-10-31"), ("2020-11-01")),
PARTITION p20201101 VALUES [("2020-11-01"), ("2020-11-02")),
PARTITION p20201102 VALUES [("2020-11-02"), ("2020-11-03")),
PARTITION p20201103 VALUES [("2020-11-03"), ("2020-11-04")),
PARTITION p20201104 VALUES [("2020-11-04"), ("2020-11-05")),
PARTITION p20201105 VALUES [("2020-11-05"), ("2020-11-06")),
PARTITION p20201106 VALUES [("2020-11-06"), ("2020-11-07")),
PARTITION p20201107 VALUES [("2020-11-07"), ("2020-11-08")),
PARTITION p20201108 VALUES [("2020-11-08"), ("2020-11-09")),
PARTITION p20201109 VALUES [("2020-11-09"), ("2020-11-10")),
PARTITION p20201110 VALUES [("2020-11-10"), ("2020-11-11")),
PARTITION p20201111 VALUES [("2020-11-11"), ("2020-11-12")),
PARTITION p20201112 VALUES [("2020-11-12"), ("2020-11-13")),
PARTITION p20201113 VALUES [("2020-11-13"), ("2020-11-14")),
PARTITION p20201114 VALUES [("2020-11-14"), ("2020-11-15")),
PARTITION p20201115 VALUES [("2020-11-15"), ("2020-11-16")),
PARTITION p20201116 VALUES [("2020-11-16"), ("2020-11-17")),
PARTITION p20201117 VALUES [("2020-11-17"), ("2020-11-18")),
PARTITION p20201118 VALUES [("2020-11-18"), ("2020-11-19")),
PARTITION p20201119 VALUES [("2020-11-19"), ("2020-11-20")),
PARTITION p20201120 VALUES [("2020-11-20"), ("2020-11-21")),
PARTITION p20201121 VALUES [("2020-11-21"), ("2020-11-22")),
PARTITION p20201122 VALUES [("2020-11-22"), ("2020-11-23")),
PARTITION p20201123 VALUES [("2020-11-23"), ("2020-11-24")),
PARTITION p20201124 VALUES [("2020-11-24"), ("2020-11-25")),
PARTITION p20201125 VALUES [("2020-11-25"), ("2020-11-26")),
PARTITION p20201126 VALUES [("2020-11-26"), ("2020-11-27")),
PARTITION p20201127 VALUES [("2020-11-27"), ("2020-11-28")),
PARTITION p20201128 VALUES [("2020-11-28"), ("2020-11-29")),
PARTITION p20201129 VALUES [("2020-11-29"), ("2020-11-30")),
PARTITION p20201130 VALUES [("2020-11-30"), ("2020-12-01")),
PARTITION p20201201 VALUES [("2020-12-01"), ("2020-12-02")),
PARTITION p20201202 VALUES [("2020-12-02"), ("2020-12-03")),
PARTITION p20201203 VALUES [("2020-12-03"), ("2020-12-04")),
PARTITION p20201204 VALUES [("2020-12-04"), ("2020-12-05")),
PARTITION p20201205 VALUES [("2020-12-05"), ("2020-12-06")),
PARTITION p20201206 VALUES [("2020-12-06"), ("2020-12-07")),
PARTITION p20201207 VALUES [("2020-12-07"), ("2020-12-08")),
PARTITION p20201208 VALUES [("2020-12-08"), ("2020-12-09")),
PARTITION p20201209 VALUES [("2020-12-09"), ("2020-12-10")),
PARTITION p20201210 VALUES [("2020-12-10"), ("2020-12-11")),
PARTITION p20201211 VALUES [("2020-12-11"), ("2020-12-12")),
PARTITION p20201212 VALUES [("2020-12-12"), ("2020-12-13")),
PARTITION p20201213 VALUES [("2020-12-13"), ("2020-12-14")),
PARTITION p20201214 VALUES [("2020-12-14"), ("2020-12-15")),
PARTITION p20201215 VALUES [("2020-12-15"), ("2020-12-16")),
PARTITION p20201216 VALUES [("2020-12-16"), ("2020-12-17")),
PARTITION p20201217 VALUES [("2020-12-17"), ("2020-12-18")),
PARTITION p20201218 VALUES [("2020-12-18"), ("2020-12-19")),
PARTITION p20201219 VALUES [("2020-12-19"), ("2020-12-20")),
PARTITION p20201220 VALUES [("2020-12-20"), ("2020-12-21")),
PARTITION p20201221 VALUES [("2020-12-21"), ("2020-12-22")),
PARTITION p20201222 VALUES [("2020-12-22"), ("2020-12-23")),
PARTITION p20201223 VALUES [("2020-12-23"), ("2020-12-24")),
PARTITION p20201224 VALUES [("2020-12-24"), ("2020-12-25")),
PARTITION p20201225 VALUES [("2020-12-25"), ("2020-12-26")),
PARTITION p20201226 VALUES [("2020-12-26"), ("2020-12-27")),
PARTITION p20201227 VALUES [("2020-12-27"), ("2020-12-28")),
PARTITION p20201228 VALUES [("2020-12-28"), ("2020-12-29")),
PARTITION p20201229 VALUES [("2020-12-29"), ("2020-12-30")),
PARTITION p20201230 VALUES [("2020-12-30"), ("2020-12-31")),
PARTITION p20201231 VALUES [("2020-12-31"), ("2021-01-01")),
...
PARTITION p20210110 VALUES [("2021-01-10"), ("2021-01-11")),
...
PARTITION p20210710 VALUES [("2021-07-10"), ("2021-07-11")),
PARTITION p20210711 VALUES [("2021-07-11"), ("2021-07-12")),
PARTITION p20210712 VALUES [("2021-07-12"), ("2021-07-13")),
PARTITION p20210713 VALUES [("2021-07-13"), ("2021-07-14")),
PARTITION p20210714 VALUES [("2021-07-14"), ("2021-07-15")),
PARTITION p20210715 VALUES [("2021-07-15"), ("2021-07-16")),
PARTITION p20210716 VALUES [("2021-07-16"), ("2021-07-17")),
PARTITION p20210717 VALUES [("2021-07-17"), ("2021-07-18")),
PARTITION p20210718 VALUES [("2021-07-18"), ("2021-07-19")),
PARTITION p20210719 VALUES [("2021-07-19"), ("2021-07-20")),
PARTITION p20210720 VALUES [("2021-07-20"), ("2021-07-21")),
PARTITION p20210721 VALUES [("2021-07-21"), ("2021-07-22")),
PARTITION p20210722 VALUES [("2021-07-22"), ("2021-07-23")),
PARTITION p20210723 VALUES [("2021-07-23"), ("2021-07-24")),
PARTITION p20210724 VALUES [("2021-07-24"), ("2021-07-25")),
PARTITION p20210725 VALUES [("2021-07-25"), ("2021-07-26")),
PARTITION p20210726 VALUES [("2021-07-26"), ("2021-07-27")),
PARTITION p20210727 VALUES [("2021-07-27"), ("2021-07-28")),
PARTITION p20210728 VALUES [("2021-07-28"), ("2021-07-29")),
PARTITION p20210729 VALUES [("2021-07-29"), ("2021-07-30")),
PARTITION p20210730 VALUES [("2021-07-30"), ("2021-07-31")),
...
PARTITION p20210809 VALUES [("2021-08-09"), ("2021-08-10")),
PARTITION p20210810 VALUES [("2021-08-10"), ("2021-08-11")),
PARTITION p20210811 VALUES [("2021-08-11"), ("2021-08-12")),
PARTITION p20210812 VALUES [("2021-08-12"), ("2021-08-13")),
PARTITION p20210813 VALUES [("2021-08-13"), ("2021-08-14")),
PARTITION p20210814 VALUES [("2021-08-14"), ("2021-08-15")),
PARTITION p20210815 VALUES [("2021-08-15"), ("2021-08-16")),
PARTITION p20210816 VALUES [("2021-08-16"), ("2021-08-17")),
PARTITION p20210817 VALUES [("2021-08-17"), ("2021-08-18")),
PARTITION p20210818 VALUES [("2021-08-18"), ("2021-08-19")),
PARTITION p20210819 VALUES [("2021-08-19"), ("2021-08-20")),
PARTITION p20210820 VALUES [("2021-08-20"), ("2021-08-21")),
PARTITION p20210821 VALUES [("2021-08-21"), ("2021-08-22")),
PARTITION p20210822 VALUES [("2021-08-22"), ("2021-08-23")),
PARTITION p20210823 VALUES [("2021-08-23"), ("2021-08-24")),
PARTITION p20210824 VALUES [("2021-08-24"), ("2021-08-25")),
PARTITION p20210825 VALUES [("2021-08-25"), ("2021-08-26")),
PARTITION p20210826 VALUES [("2021-08-26"), ("2021-08-27")),
PARTITION p20210827 VALUES [("2021-08-27"), ("2021-08-28")),
PARTITION p20210828 VALUES [("2021-08-28"), ("2021-08-29")),
PARTITION p20210829 VALUES [("2021-08-29"), ("2021-08-30")),
PARTITION p20210830 VALUES [("2021-08-30"), ("2021-08-31")),
PARTITION p20210831 VALUES [("2021-08-31"), ("2021-09-01")),
PARTITION p20210901 VALUES [("2021-09-01"), ("2021-09-02")),
PARTITION p20210902 VALUES [("2021-09-02"), ("2021-09-03")),
PARTITION p20210903 VALUES [("2021-09-03"), ("2021-09-04")),
PARTITION p20210904 VALUES [("2021-09-04"), ("2021-09-05")),
PARTITION p20210905 VALUES [("2021-09-05"), ("2021-09-06")),
PARTITION p20210906 VALUES [("2021-09-06"), ("2021-09-07")),
PARTITION p20210907 VALUES [("2021-09-07"), ("2021-09-08")),
PARTITION p20210908 VALUES [("2021-09-08"), ("2021-09-09")),
PARTITION p20210909 VALUES [("2021-09-09"), ("2021-09-10")),
PARTITION p20210910 VALUES [("2021-09-10"), ("2021-09-11")),
PARTITION p20210911 VALUES [("2021-09-11"), ("2021-09-12")),
...
PARTITION p20211227 VALUES [("2021-12-27"), ("2021-12-28")),
PARTITION p20211228 VALUES [("2021-12-28"), ("2021-12-29")),
PARTITION p20211229 VALUES [("2021-12-29"), ("2021-12-30")),
PARTITION p20211230 VALUES [("2021-12-30"), ("2021-12-31")),
