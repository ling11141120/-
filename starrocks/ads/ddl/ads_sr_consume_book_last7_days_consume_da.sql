CREATE TABLE `ads_sr_consume_book_last7_days_consume_da` (
...
PRIMARY KEY(`dt`, `book_id`, `language`)
COMMENT "书籍近7天阅币消耗累计汇总表"
...
DISTRIBUTED BY HASH(`book_id`, `language`) BUCKETS 1 
PROPERTIES (
"replication_num" = "3",
