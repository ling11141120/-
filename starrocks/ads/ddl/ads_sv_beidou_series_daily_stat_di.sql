...
(
    ...
    ,code_stage                  int                   comment "阶段"
    ,plan_round                  int                   comment "测试轮次"
    ,spend                       decimal(14, 4)        comment "总花费"
    ,income_amt                  decimal(14, 4)        comment "收入"
    ...
    -- 免费/付费集有效观看与流失指标
    ,free_effective_watch_user   bitmap                comment "免费集有效观看用户"
    ,free_loss_watch_user        bitmap                comment "免费集流失观看用户"
    ,paid_effective_watch_user   bitmap                comment "付费集有效观看用户"
    ,paid_loss_watch_user        bitmap                comment "付费集流失观看用户"
