CREATE TABLE `feedback_tracking_issue` (
  ...
  `issue_or_requirement` varchar(255) NULL COMMENT "问题或需求类型（问题/需求）",
  `description` varchar(65533) NULL COMMENT "问题或需求的描述",
  `screenshot` varchar(65533) NULL COMMENT "问题或需求的截图链接或内容",
