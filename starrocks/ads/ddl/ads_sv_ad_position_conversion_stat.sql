drop table if exists ads.ads_sv_ad_position_conversion_stat;
create table ads.ads_sv_ad_position_conversion_stat (
    dt                     date           not null                     comment "日期"
   ,md5_key                varchar(32)    not null                     comment "md5主键"
   ,ad_position_id         varchar(50)                                 comment "广告位置id"
   ...
   ,ad_position_name       varchar(200)                                comment "广告位置名称"
...
comment "海剧-广告触达到播放转化报表-分广告位置转化统计"
