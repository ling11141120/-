CREATE TABLE `ads_sv_finance_series_recharge_consume_info_jsconsume` (
  `dt` date NOT NULL COMMENT "日期",
  `one_id` bigint(20) NOT NULL COMMENT "唯一id",
