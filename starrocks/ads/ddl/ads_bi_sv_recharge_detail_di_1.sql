CREATE TABLE `ads_bi_sv_recharge_detail_di_1` (
...
PRIMARY KEY(`dt`, `product_id`, `strategy_id`, `recharge_source`)
COMMENT "海剧充值明细报表"
DISTRIBUTED BY HASH(`dt`, `product_id`, `strategy_id`) BUCKETS 3 
PROPERTIES (
"replication_num" = "3",
"in_memory" = "false",
