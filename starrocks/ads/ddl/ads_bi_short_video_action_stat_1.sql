CREATE TABLE `ads_bi_short_video_action_stat_1` (
  ...
  `all_unlock_user_bitmap` bitmap NULL COMMENT "解锁user+svip观看付费集数用户的bitmap",
  `unlock_user_epis_cnt` int(11) NULL COMMENT "用户解锁总集数",
