CREATE TABLE `ads_sr_finance_book_recharge_consume_info_sync` (
  ...
  `remain_amount` decimal(12, 2) NULL COMMENT "剩余金额(阅币)-根据mobo订单处理后",
  `remain_amount_all` decimal(12, 2) NULL COMMENT "剩余金额(阅币)-原始全量流水(不更新该字段)",
