CREATE TABLE `ads_srsv_marketing_plan_d` (
...
PRIMARY KEY(`dt`, `project_code`, `source_chl`, `code_id`)
COMMENT "海阅海剧-超前点播章节策略自动化-快照表-林永煌需求"
DISTRIBUTED BY HASH(`dt`, `project_code`, `source_chl`, `code_id`) BUCKETS 1 
PROPERTIES (
"replication_num" = "3",
"in_memory" = "false",
