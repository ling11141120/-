CREATE TABLE `ads_srsv_advance_streaming_consume_ed` (
...
PRIMARY KEY(`dt`, `product_id`, `code_id`)
COMMENT "海阅海剧-超前点播章节策略自动化-书/剧每日消耗表"
DISTRIBUTED BY HASH(`dt`, `product_id`, `code_id`) BUCKETS 1 
PROPERTIES (
"replication_num" = "3",
"in_memory" = "false",
