CREATE TABLE `ads_bi_first_wide_active` (
  `dt` date NOT NULL COMMENT "活跃日期",
  ...
  INDEX index_sex (`sex`) USING BITMAP COMMENT 'index_sex'
) ENGINE=OLAP 
...
PROPERTIES (
"replication_num" = "3",
"bloom_filter_columns" = "country, ver, reg_time, reg_country",
