...
-- 来源表：
--        readerlog_fr.UserVipLog
--        readerlog_pt.UserVipLog
--        readerlog_ft.UserVipLog
--        readerlog_en.UserVipLog
--        readerlog_ru.UserVipLog
--        readerlog_sp.UserVipLog
--        readerlog_jp.UserVipLog
--        readerlog_id.UserVipLog
--        readerlog_th.UserVipLog
--        readerlog_and2_sync.UserVipLog
--        readerlog_cd2_sync.UserVipLog
-- 来源负责：
-- 采集工具： SeaTunnel
-- 开发人： qhr
-- 开发日期： 2025-12-01
----------------------------------------------------------------
drop table if exists ods_log.ods_book_log_userviplog;
create table ods_log.ods_book_log_userviplog (
