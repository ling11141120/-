...
-- 来源表：
--        readerlog_fr.UserAwardMoneyLog
--        readerlog_pt.UserAwardMoneyLog
--        readerlog_ft.UserAwardMoneyLog
--        readerlog_en.UserAwardMoneyLog
--        readerlog_ru.UserAwardMoneyLog
--        readerlog_sp.UserAwardMoneyLog
--        readerlog_jp.UserAwardMoneyLog
--        readerlog_id.UserAwardMoneyLog
--        readerlog_th.UserAwardMoneyLog
--        readerlog_and2_sync.UserAwardMoneyLog
--        readerlog_cd2_sync.UserAwardMoneyLog
-- 来源负责：
-- 采集工具： SeaTunnel
-- 开发人： qhr
-- 开发日期： 2025-12-01
...
drop table if exists ods_book_log_userawardmoneylog;
create table ods_book_log_userawardmoneylog (
