----------------------------------------------------------------
-- 目标表： ods_log.ods_book_log_usergiftmoneylog
-- 来源实例： old_tidb_source
-- 来源表：
--        readerlog_fr.UserGiftMoneyLog
--        readerlog_pt.UserGiftMoneyLog
--        readerlog_ft.UserGiftMoneyLog
--        readerlog_en.UserGiftMoneyLog
--        readerlog_ru.UserGiftMoneyLog
--        readerlog_sp.UserGiftMoneyLog
--        readerlog_jp.UserGiftMoneyLog
--        readerlog_id.UserGiftMoneyLog
--        readerlog_th.UserGiftMoneyLog
--        readerlog_and2_sync.UserGiftMoneyLog
--        readerlog_cd2_sync.UserGiftMoneyLog
-- 来源负责：
-- 采集工具： SeaTunnel
-- 开发人： qhr
-- 开发日期： 2025-12-01
...
drop table if exists ods_log.ods_book_log_usergiftmoneylog;
create table ods_log.ods_book_log_usergiftmoneylog (
