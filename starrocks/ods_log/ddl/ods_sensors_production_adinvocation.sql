----------------------------------------------------------------
-- 目标表：ods_log.ods_sensors_production_adinvocation
-- 来源实例：
-- 来源表：
-- 来源负责：
-- 采集工具：极光-实时映射
...
drop table if exists ods_log.ods_sensors_production_adinvocation;
create table ods_log.ods_sensors_production_adinvocation (
