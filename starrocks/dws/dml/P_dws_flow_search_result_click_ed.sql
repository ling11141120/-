...
-- workflow_name    : tbl_dws_flow_search_result_click_ed
-- workflow_version : 2
-- create_user      : yanxh
-- task_name        : dws_flow_search_result_click_ed
-- task_version     : 2
-- update_time      : 2023-12-25 15:00:07
-- sql_path         : \starrocks\tbl_dws_flow_search_result_click_ed\dws_flow_search_result_click_ed
----------------------------------------------------------------
-- 前置SQL语句
delete from dws.dws_flow_search_result_click_ed  where  dt>='${bf_3_dt}';

-- SQL语句
insert into   dws.dws_flow_search_result_click_ed
 ...
 from dwd.dwd_sensors_production_searchresultclick_view a
 left join
