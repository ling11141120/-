...
-- workflow_name    : tbl_dws_flow_search_result_exposure_ed
-- workflow_version : 2
-- create_user      : yanxh
-- task_name        : dws_flow_search_result_exposure_ed
-- task_version     : 2
-- update_time      : 2023-12-25 14:59:11
-- sql_path         : \starrocks\tbl_dws_flow_search_result_exposure_ed\dws_flow_search_result_exposure_ed
----------------------------------------------------------------
-- 前置SQL语句
delete from dws.dws_flow_search_result_exposure_ed  where  dt>='${bf_3_dt}';

-- SQL语句
insert into   dws.dws_flow_search_result_exposure_ed
  ...
  a.page_name,a.page_id,a.element_name,a.element_id,a.send_id,a.search_mode,
  keyword as key_word, count(1) as cnt,now() as etl_tm
 from dwd.dwd_sensors_production_searchresultexposure_view a
 left join
