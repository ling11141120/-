CREATE TABLE `dws_flow_page_view_ed` (
  ...
  `url` varchar(65533) NULL COMMENT "页面地址",
  `url_host` varchar(65533) NULL COMMENT "页面地址域名",
  `url_path` varchar(65533) NULL COMMENT "页面地址路径",
  `title` varchar(65533) NULL COMMENT "页面标题",
