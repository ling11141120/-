CREATE TABLE `dws_cr_ad_advertising_cost_moni` (
  `month` int(11) NOT NULL COMMENT "日期（createtime）",
...
COMMENT "国内小程序阅读-按月投放广费用表"
DISTRIBUTED BY HASH(`month`, `product_id`) BUCKETS 1 
PROPERTIES (
"replication_num" = "3",
"in_memory" = "false",
