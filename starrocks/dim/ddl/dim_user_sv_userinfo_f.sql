...
create table dim.dim_user_sv_userinfo_f (
    ...
    ,sex_cd                int               comment "性别编码"
    ,sex_name              varchar(50)       comment "性别名称"
    ,create_time           datetime          comment "创建时间"
    ,user_status_cd        tinyint           comment "用户状态编码"
