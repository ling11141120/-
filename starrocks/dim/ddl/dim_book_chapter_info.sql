drop table if exists dim.dim_book_chapter_info;
create table if not exists dim.dim_book_chapter_info (
...
comment "书籍章节信息表"
distributed by hash(book_id, site_id, serial_number, chapter_id) buckets 70
properties (
    "replication_num" = "3",
