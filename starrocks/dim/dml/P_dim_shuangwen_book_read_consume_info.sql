...
select a1.productid
  ...
  from (
        ...
        select b1.productid
              ...
              ,b1.authortype
          from (
                select case when c1.siteid = 410 then 3311
                            when c1.siteid = 414 then 3501
                            when c1.siteid = 433 then 3511
                            when c1.siteid in (412,415,413) then 3366
                        end                                      as productid
        ...
        select b1.productid
          ...
          from (
                select c1.productid
                      ...
                      ,c1.bookcode
                      ,c1.fulltime
                      ,case when c1.siteid = 322 then 3
                            when c1.siteid = 436 then 14
                            when c1.siteid = 445 then 15
                            when c1.siteid = 435 then 13
                            when c1.siteid = 497 then 22
                        end                                      as languageid
                      ,c1.authorid
                      ,c1.authorname
                      ,c1.isputdown
        ...
        select b1.productid
              ...
              ,b1.authortype
          from (
                select case when c1.siteid = 375 then 3388
                            when c1.siteid = 418 then 3371
                            when c1.siteid = 419 then 3399
                        end                                      as productid
                      ,(c1.bookid * 1000) + c1.siteid              as bookid
                      ,c1.bookname
                      ,c1.createtime
                      ...
                      ,c1.bookcode
                      ,c1.fulltime
                      ,if(c1.siteid = 419, 9, c1.language)         as languageid
                      ,c1.authorid
                      ,c1.authorname
                      ,c1.isputdown
                      ,c1.putdownlevel
