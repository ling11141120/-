...
-- crontab：0 24,44 * * * ?
------------------------------------------------
select abs((t2.charge_money - t1.charge_money) / t1.charge_money * 100) as ratio
from (select sum(base_amount) as charge_money
...
, (select charge_money from ads.ads_report_short_vedio_charge_info where datetypes = 1) as t2
;
